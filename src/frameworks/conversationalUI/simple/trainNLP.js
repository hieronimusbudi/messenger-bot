...
module.exports = async function trainnlp(manager) {
    ...
    console.log('waiting for NLP Training...');
    manager.addDocument('en', 'yes', 'special.yes');
    manager.addDocument('en', 'of course', 'special.yes');
    manager.addDocument('en', 'yeah', 'special.yes');
    manager.addDocument('en', 'yup', 'special.yes');
    manager.addDocument('en', 'ya', 'special.yes');
    manager.addDocument('en', "i want", 'special.yes');

    manager.addDocument('en', 'no', 'special.no');
    manager.addDocument('en', 'nah', 'special.no');
    manager.addDocument('en', "dont't want", 'special.no');
    manager.addDocument('en', 'nga', 'special.no');
    manager.addDocument('en', 'ndak', 'special.no');
    manager.addDocument('en', 'tidak', 'special.no');
    ...
    manager.addAnswer('en', 'special.yes', "special-yes");
    manager.addAnswer(
        'en',
        'special.no',
        'special-no'
    ...
    manager.save();
    console.log('NLP training is done. Good Luck.');
};